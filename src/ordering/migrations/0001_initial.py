...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Selectable'
        db.create_table('ordering_selectable', (
        ...
        db.send_create_signal('ordering', ['Selectable'])


    def backwards(self, orm):
        
        # Deleting model 'Selectable'
        db.delete_table('ordering_selectable')
