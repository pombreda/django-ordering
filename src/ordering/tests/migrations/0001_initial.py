...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('tests_testitem', (
            ...
            ('vendor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ordering.Selectable'])),
        ))
        db.send_create_signal('tests', ['TestItem'])


    def backwards(self, orm):
        
        # Deleting model 'TestItem'
        db.delete_table('tests_testitem')
